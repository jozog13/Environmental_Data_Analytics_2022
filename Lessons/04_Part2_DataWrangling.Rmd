...
NTL.nutrient.data.PeterPaul.gathered <- subset(NTL.nutrient.data.PeterPaul.gathered, !is.na(concentration)) # remove na values
count(NTL.nutrient.data.PeterPaul.gathered, "nutrient") # counts number of obs for each nutrient 
