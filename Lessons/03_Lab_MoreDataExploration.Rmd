...
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # counts down
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # counts across
matrix2
...
matrix1[c(12, 14)] # gives 12th and 14th item
matrix1[c(12:14)] # gives values from 12th, 13th, and 14th (gives a slice)
matrix1[2:4, 1:3] # gives rows 2,3,4 and columns 1,2,3
...
list1[[2]] # gets second item in the list (same as doing list1$mynumbers)
...
dataframe1[1:2,] # first 2 rows and all columns
dataframe1[c("ID","Passed")] # gives ID and Passed columns 
dataframe1$ID
...
```{r}
highF <- c(44,50,33,43,51,54,59,66,57,42)
lowF <- c(27,27,15,25,26,35,47,53,30,22)
```
...
```{r}
df1 <- data.frame(highF,highC,lowF,lowC)
```
