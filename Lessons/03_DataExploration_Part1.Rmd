...
> Answer: output is shown in the console, shows info about the package being loaded/installed
...
> ANSWER: in the data _> metadata folder 
...
> Answer: never remove NA's from time series, be careful when removing NAs when they are in the middle of the dataset 
